...
func NewGreetServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GreetServiceClient {
	...
	return &greetServiceClient{
		...
		greetClientStream: connect_go.NewClient[v1.GreetClientStreamRequest, v1.GreetClientStreamResponse](
			httpClient,
			baseURL+"/protocolbuffers.greet.v1.GreetService/GreetClientStream",
			opts...,
		),
		greetBidiStream: connect_go.NewClient[v1.GreetBidiStreamRequest, v1.GreetBidiStreamResponse](
			httpClient,
			baseURL+"/protocolbuffers.greet.v1.GreetService/GreetBidiStream",
			opts...,
		),
	}
}
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/protocolbuffers.greet.v1.GreetService/GreetClientStream", connect_go.NewClientStreamHandler(
		"/protocolbuffers.greet.v1.GreetService/GreetClientStream",
		svc.GreetClientStream,
		opts...,
	))
	mux.Handle("/protocolbuffers.greet.v1.GreetService/GreetBidiStream", connect_go.NewBidiStreamHandler(
		"/protocolbuffers.greet.v1.GreetService/GreetBidiStream",
		svc.GreetBidiStream,
		opts...,
	))
